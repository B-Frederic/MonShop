  ...
  return (
    <div>
      <img
        ...
        alt="img water"
      />
      <div className="w-[90%] mx-auto py-20 flex lg:flex-row flex-col lg:items-start items-center">
        <CartItem />
        <div className="lg:w-1/3 w-[300px] h-full bg-[#fafafa] lg:mt-0 mt-8 py-6 px-4 sm:">
