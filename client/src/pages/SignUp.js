...
const SignUp = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mx-auto my-20">
      <form onSubmit={signUpForm} className="flex flex-col mt-10">
        ...
        <button
          type="submit"
          className="w-[300px] justify-center mt-10 bg-gray-600 text-white py-2 px-4 font-semibold tracking-wide rounded-md hover:bg-gray-800 duration-300"
        >
          Envoyer
        </button>
      </form>
